...
//   mapImage: "/images/static-map.webp", // Imagen estática del mapa
...
//       {/* Popup simulado */}
//       <div className="absolute left-6 bottom-6 bg-white rounded-md shadow-lg p-4 w-[280px] z-10">
...
//             className="bg-[#0a2a54] hover:bg-transparent hover:text-[#0a2a54] border border-[#0a2a54] text-white hover:text-[#0a2a54] text-xs py-1 px-3 rounded-md transition-colors duration-300 font-inter"
//           >
