...
//         // Crear un elemento para el marcador personalizado
//         const markerEl = document.createElement("div")
//         markerEl.className = "custom-marker"
//         markerEl.innerHTML = `
//           <div class="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center shadow-lg transform -translate-y-full">
//             <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
//               <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
//             </svg>
//           </div>
//           <div class="w-0 h-0 border-l-[8px] border-l-transparent border-r-[8px] border-r-transparent border-t-[8px] border-t-blue-500 transform -translate-y-full"></div>
//         `
