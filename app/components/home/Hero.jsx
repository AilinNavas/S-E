    ...
    <section className="relative">
      <div className="container grid grid-cols-1 items-center gap-8 px-4 md:grid-cols-2 mx-auto max-w-7xl py-16">
        <div className="flex flex-col gap-6">
          <h1 className="font-zen text-4xl font-bold leading-tight bg-gradient-to-b from-[#0a2a54] via-blue-900 to-blue-950 bg-clip-text text-transparent font-zen  uppercase md:text-5xl lg:text-6xl">
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <Link href={'/'}>
              <button className="w-full text-[#3c8dbc] border-2 border-[#3c8dbc] px-6 py-2 font-inter text-lg font-semibold rounded-md hover:bg-primary/70 ease-in-out duration-300">Refer Now</button>
            </Link>
          </div>
