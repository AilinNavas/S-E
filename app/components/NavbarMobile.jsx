...
const AnimatedHamburgerButton = ({ isSpanishPage }) => {
  ...
  const proceduresLinks = [
    ...
    },
    {
      ...
      href: "/procedures/speaking-spanish-endodontics",
    },
    {
      en: "Endodontist Fort Worth",
      es: "Endodoncista en Fort Worth",
      href: "/procedures/endodontist-fort-worth",
    },
    {
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="flex-1 overflow-y-auto">
                  <nav className="flex flex-col items-start justify-start space-y-8 p-8 font-inter text-2xl">
                    ...
                    <div className="flex">
                      <Link href="/book-appointment" className="text-[#0a2a54]" onClick={handleLinkClick}>
                        {isSpanishPage ? "Agendar Cita" : "Book An Appointment"}
                      </Link>
                    </div>

                    <div className="flex">
                      <Link href="/refer" className="text-[#0a2a54]" onClick={handleLinkClick}>
...
//            className="fixed top-0 left-0 right-0 bottom-0 bg-primary z-10 overflow-auto"
//          >
//            <nav className="flex bg-white mt-28 md:mt-40 flex-col items-start justify-start space-y-8 h-full p-8 font-inter text-2xl">
//              <div className="flex">
//                <Link href="/about-us" className="text-[#0a2a54]" onClick={handleLinkClick}>
//                  {isSpanishPage ? "Sobre nosotros" : "About Us"}
//                </Link>
...
//                  <button className="flex items-center bg-[#119960] border-2 border-[#119960] hover:bg-[#119960]/80 text-white px-8 py-3 font-inter font-semibold rounded-md hover:bg-primary/70 ease-in-out duration-300">
//                    <Phone className="w-6 h-6 mr-2 text-white"/>{isSpanishPage ? "Llamar Ahora" : "Call Us"}
//                  </button>
//                </Link>
//            </nav>
//          </motion.div>
