      ...
      <nav className="max-w-7xl mx-auto h-30 flex justify-between">
        ...
        <div className="flex justify-end items-center w-10/12">
          ...
          <div className="hidden lg:flex ml-12 space-x-4">
            <Link href={"/"}>
              <button className="rounded-md px-6 py-2 text-lg font-inter bg-[#3c8dbc] text-white border-[#3c8dbc] border-2 font-semibold hover:bg-[#3c8dbc]/90 ease-in duration-300 cursor-pointer">
                {isSpanishPage ? "Agendar Cita" : "Book An Appointment"}
              </button>
            </Link>
            <Link href={"/"}>
              <button className="text-[#3c8dbc] border-2 border-[#3c8dbc] px-6 py-2 font-inter text-lg font-semibold rounded-md hover:bg-primary/70 ease-in-out duration-300 cursor-pointer">
