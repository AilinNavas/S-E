  ...
  return (
    <section id={id} className=" bg-white py-16">
      <div className='max-w-7xl px-4 mx-auto lg:px-0'>
        <h2 className="bg-gradient-to-b from-[#0a2a54] via-blue-900 to-blue-950 bg-clip-text text-transparent mb-4 text-center font-zen uppercase font-semibold text-3xl md:text-5xl pb-8">{title}</h2>
